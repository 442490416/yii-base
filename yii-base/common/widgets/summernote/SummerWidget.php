...
class SummerWidget extends InputWidget
{
    ...
    {
        $summerAsset = SummerAsset::register($this->view);

        $script = $summerAsset->dealOptionsAndGetScript($this->view,$this->id,$this->summerOptions,$this->uploadUrl);
